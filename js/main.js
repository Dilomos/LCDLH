        ...
        if (typeof (Storage) !== "undefined") {
            ...
            if (rawDecks !== null) {
                ...
                deckDatas.forEach(function (deckData){
                    var  deck= new Deck(deckData.name, deckData.displayName,deckData.version, deckData.availableCards, deckData.playedCards, deckData.availableTraits, deckData.expansions );
